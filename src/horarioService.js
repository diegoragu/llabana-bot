 ...
 * L-V: 9am-5pm | Sáb: 9am-2pm | Dom: sin atención
 */
...
function estaEnHorario() {
  ...
  if (dia >= 1 && dia <= 5) return hora >= 9 && hora < 17; // L-V
